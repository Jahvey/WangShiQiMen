        ...
        public class ChineseCalendar
        {
            ...
            public string DateString
            {
                get
                {
                    ...
                    return "公元"+this._datetime.ToLongDateString()+""+this._datetime.ToLongTimeString();
                }
            }
            #endregion
            ...
            public string ChineseTwentyFourPrevDay
            {
                get
                {
                    ...
                    for (int i = 24; i >= 1; i--)
                    {
                        ...
                        newDate = baseDateAndTime.AddMinutes(num);//按秒计算

                        if (newDate.DayOfYear < _date.DayOfYear)
                        {
                            tempStr = string.Format("{0}[{1}]", SolarTerm[i - 1], newDate.ToString("yyyy-MM-dd HH:mm:ss"));
                            break;
                        }
                    }
